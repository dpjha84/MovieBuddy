...
namespace RecyclerViewer
{
    ...
    {
        List<SearchMovie> GetData(int year, int month);
    ...
    public class Review
    {
        ...
        public Java.Lang.Object Image { get; set; }
    }
        ...
        public async Task<List<Review>> GetReviews(int movieId, string movieName, string imdbId, bool upcoming)
        {
            ...
            return new List<Review>
            {
                new Review
                {
                    ...
                    Text = "Nice Movie",
                    Rating = MovieManager.GetToiRating(movieId, movieName, true),
                ...
                new Review
                {
                    ...
                    Text = "Nice Movie",
                    Rating = MovieManager.GetHtRating(movieId, movieName, true),
                ...
                new Review
                {
                    Reviewer = "IMDB",
                    Text = "Average Movie",
                    Rating = MovieManager.GetImdbData(movieId, imdbId, true),
